...
namespace Finance_Authority.BL
{
    class CLS_Employee_Salaries
    {
        ...
        public DataTable Employee_Salaries_By_id_Between_Date(int Employee_id, DateTime Date_first, DateTime Date_last)
        {
            DAL.DATA_ACCESS_LAYER DAL = new DAL.DATA_ACCESS_LAYER();
            DataTable Dt = new DataTable();
            DAL.open();
            ...
            Dt = DAL.selectdata("Employee_Salaries_By_id_Between_Date", param);
            DAL.close();
            return Dt;
        }
    }
