...
namespace Finance_Authority.BL
{
    class CLS_Payment_Document
    {
        ...
        public DataTable Payment_Document_Max_ID()
        {
            DAL.DATA_ACCESS_LAYER DAL = new DAL.DATA_ACCESS_LAYER();
            DAL.open();
            DataTable Dt = new DataTable();
            Dt = DAL.selectdata("Payment_Document_Max_ID", null);
            DAL.close();
            return Dt;
        }
        ...
        public DataTable Payment_Document_Search_by_id(int id)
        {
            DAL.DATA_ACCESS_LAYER DAL = new DAL.DATA_ACCESS_LAYER();
            DataTable Dt = new DataTable();
            DAL.open();
            ...
            param[0].Value = id;
            Dt = DAL.selectdata("Payment_Document_Search_by_id", param);
            DAL.close();
            return Dt;
        }
