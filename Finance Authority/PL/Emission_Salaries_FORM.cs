...
namespace Finance_Authority.PL
{
    public partial class Emission_Salaries_FORM : MetroFramework.Forms.MetroForm
    {
        ...
        {
            // اصبحت الاضافة في واجهة تسليم الرواتب
        ...
        private void Emission_Salaries_update_Click(object sender, EventArgs e)
        {
            ...
            //// لانسمح بتعديل اسم المكتب بالتالي تم الاستغناء عن العمليات التالية
            ...
            Emission_Salaries_delete.Enabled = false;
            Emission_Salaries_Brows_Docs.Enabled = false;
            Emission_Salaries_Details.Enabled = false;
        }
        ...
        private void Emission_Salaries_dataGrid_Click(object sender, EventArgs e)
        {
            if (Emission_Salaries_dataGrid.CurrentRow != null)
            {
                ...
                Emission_Salaries_Details.Enabled = true;
            }
        }
        ...
        private void Emission_Salaries_Details_Click(object sender, EventArgs e)
        {
            Employee_Salaries_Details_FORM FRM = new Employee_Salaries_Details_FORM(Program.Emission_Salaries_id);
            FRM.ShowDialog();
        }
    }
}
