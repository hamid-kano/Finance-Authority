...
namespace Finance_Authority.PL
{
    public partial class Employee_FORM : MetroFramework.Forms.MetroForm
    {
        ...
        int contract_id;
        int Employee_id;
        public Employee_FORM(int Employee_ID )
        {
            InitializeComponent();
            ...
            _Empolyee_ID = Employee_ID;
            if (_Empolyee_ID!=-1)
            {
                
                Employee_add.Text = "تعديل";
                Dt = Emp.Employee_Description_View_id(_Empolyee_ID);
                Dt_emp = Emp.Employee_View_id((int)Dt.Rows[0][0]);
        ...
        private void Employee_add_Click(object sender, EventArgs e)
        {
            ...
            //{
            //    if ((int)Dt_emp.Rows[i][0] != Program.Employee_id)
            //    {
            ...
            else
            {
              ...
              , Employee_Marital_status.Text, Employee_Pr_Service_Years.Text, Employee_id);
                ...
                if (Employee_Description_Comb_Satutes.Text == "عقد")
                {
                    ...
                    , Contracts_Notes.Text, _Empolyee_ID, contract_id);
                }
