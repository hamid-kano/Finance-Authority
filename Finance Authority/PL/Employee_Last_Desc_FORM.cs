...
{
    public partial class Employee_Last_Desc_FORM : MetroFramework.Forms.MetroForm
    {
        ...
        int Employee_id;
        public Employee_Last_Desc_FORM(int Empolyee_Description_ID)
        {
            InitializeComponent();
        ...
        private void Employee_Edit_Click(object sender, EventArgs e)
        {
            ...
            {
                Empl_Des.Employee_Description_update(CB_in_work.Checked ? Employee_Description_Comb_Satutes.Text: Employee_Description_Comb_out_work_Statues.Text, Employee_Description_Now.Checked,
                    Employee_Description_DateTime.Value, Employee_Description_N0_Book.Text, Employee_Description_Salery.Text, Convert.ToInt32(Employee_Description_Comb_Department.SelectedValue),
            ...
            else
            {
                ...
                Empl_Des.Employee_Description_add(CB_in_work.Checked ? Employee_Description_Comb_Satutes.Text : Employee_Description_Comb_out_work_Statues.Text, true, Employee_Description_DateTime.Value,
